...
ActiveRecord::Schema[7.2].define(version: 2026_02_14_073600) do
  ...
  create_table "calendar_entries", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["document_id", "calendar_date"], name: "index_calendar_entries_on_document_and_date", unique: true
    t.index ["document_id"], name: "index_calendar_entries_on_document_id"
    t.index ["user_id", "calendar_date"], name: "index_calendar_entries_on_user_id_and_calendar_date"
  ...
  add_foreign_key "calendar_entries", "documents"
